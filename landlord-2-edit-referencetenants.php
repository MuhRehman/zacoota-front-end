...
<!--referencetenants -->
<div class="referencetenants holding-deposit-landlord edit">
    <div class="container">
        ...
        <div class="content-wrap">
            ...
            <div class="referencing-options in-progress">
                <h6>In Progress </h6>
                ...
                <table class="table references-table ">
                    ...
                    <tr>
                        ...
                        <td>
                           <span class="type"> Comprehensive Reference</span>
                        </td>
                        <td>
            ...
            <div class="referencing-btn">
                <div class="inner">
                    <div class="action">
                        ...
                        <a href="#" class="btn-1"> View ongoing References</a>
                    </div>
                </div>
            </div>
        </div>
